...
EventLogger = (function () {
  return {
    ...
    ******************************************************************/
    ...
    logMarkPurpose: function (word, previousState) {
      //var word = Words.findOne({_id: wordID});
	  //var word = WordManager.findOne(wordID);
    ...
    logMarkMechanism: function (word, previousState) {
      //var word = Words.findOne({_id: wordID});
	  //var word = WordManager.findOne(wordID);
    ...
    logUnmarkWord: function (word, previousState) {
      //var word = Words.findOne({_id: wordID});
	  //var word = WordManager.findOne(wordID);
