...
EventLogger = (function () {
  return {
    ...
    ******************************************************************/
    ...
    logSelectMatch: function (query, matchingDoc, rank) {
      var msg = "User selected a matching doc";
      var data = {'seedDoc': Session.get("currentDoc"),
                  'query': query,
    ...
    logRejectMatch: function(query, matchingDoc, rank) {
      var msg = "User rejected a matching doc";
      var data = {'seedDoc': Session.get("currentDoc"),
                  'query': query,
                  'matchingDoc': matchingDoc,
                  'rank': rank,
    ...
    logMatchSubmission: function(docMatch) {
